...
async function serializeMediaItem(item: MediaItem): Promise<SerializedMediaItem> {
  ...
  return {
    ...
    blur: normalizeMediaBlur(item.blur),
...
function deserializeMediaItem(data: SerializedMediaItem): MediaItem {
  ...
  return {
    ...
    blur: normalizeMediaBlur(data.blur),
...
async function serializeNarrationClip(clip: NarrationClip): Promise<SerializedNarrationClip> {
  ...
  return {
    ...
    aiNarrationScene: clip.aiNarrationScene,
    aiTtsEngine: clip.aiTtsEngine,
    aiTtsTone: clip.aiTtsTone,
    aiTtsPace: clip.aiTtsPace,
    aiTtsStyleDetail: clip.aiTtsStyleDetail,
    fadeIn: clip.fadeIn,
...
function deserializeNarrationClip(data: SerializedNarrationClip): NarrationClip {
  ...
  return {
    ...
    aiNarrationScene: data.aiNarrationScene,
    aiTtsEngine: data.aiTtsEngine as NarrationClip['aiTtsEngine'],
    aiTtsTone: data.aiTtsTone as NarrationClip['aiTtsTone'],
    aiTtsPace: data.aiTtsPace as NarrationClip['aiTtsPace'],
    aiTtsStyleDetail: data.aiTtsStyleDetail,
    fadeIn: data.fadeIn,
    fadeOut: data.fadeOut,
    fadeInDuration: data.fadeInDuration,
    fadeOutDuration: data.fadeOutDuration,
...
function serializeCaption(caption: Caption): SerializedCaption {
  return {
    ...
    overrideTextAlign: caption.overrideTextAlign,
    overrideFontSize: caption.overrideFontSize,
    overrideFontColor: caption.overrideFontColor,
    overrideStrokeColor: caption.overrideStrokeColor,
    overrideStrokeWidth: caption.overrideStrokeWidth,
    overrideBlur: caption.overrideBlur,
    overrideBackgroundEnabled: caption.overrideBackgroundEnabled,
    overrideBackgroundColor: caption.overrideBackgroundColor,
    overrideBackgroundOpacity: caption.overrideBackgroundOpacity,
    overrideBackgroundRadius: caption.overrideBackgroundRadius,
...
function deserializeCaption(data: SerializedCaption): Caption {
  return {
    ...
    overrideTextAlign: data.overrideTextAlign,
    overrideFontSize: data.overrideFontSize,
    overrideFontColor: data.overrideFontColor,
    overrideStrokeColor: data.overrideStrokeColor,
    overrideStrokeWidth: data.overrideStrokeWidth,
    overrideBlur: data.overrideBlur,
    overrideBackgroundEnabled: data.overrideBackgroundEnabled,
    overrideBackgroundColor: data.overrideBackgroundColor,
    overrideBackgroundOpacity: data.overrideBackgroundOpacity,
    overrideBackgroundRadius: data.overrideBackgroundRadius,
