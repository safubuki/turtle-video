...
export function createAndroidPreviewCacheKey(
  ...
  return JSON.stringify({
    ...
    captions: input.captions.map((caption) => ({
      ...
      overrideTextAlign: caption.overrideTextAlign ?? null,
      ...
      overrideBackgroundEnabled: caption.overrideBackgroundEnabled ?? null,
      overrideBackgroundColor: caption.overrideBackgroundColor ?? null,
      overrideBackgroundOpacity: caption.overrideBackgroundOpacity ?? null,
      overrideBackgroundRadius: caption.overrideBackgroundRadius ?? null,
    ...
    captionSettings: {
      ...
      textAlign: input.captionSettings.textAlign ?? 'center',
      ...
      backgroundEnabled: input.captionSettings.backgroundEnabled,
      backgroundColor: input.captionSettings.backgroundColor,
      backgroundOpacity: input.captionSettings.backgroundOpacity,
      backgroundRadius: input.captionSettings.backgroundRadius,
