  ...
  return {
    ...
    clips: {
      ...
      items: [
        ...
        {
          title: 'ウォーターマーク',
          description: '動画・画像一覧の先頭にある「ウォーターマーク」（開いて設定）から操作します。',
          bullets: [
...

        {
          ...
          facts: [
            {
              label: '位置・サイズ',
              description: '拡大縮小と X／Y 位置をスライダーで調整します。',
            },
            {
              label: '回転',
      ...
      items: [
        ...
        },
        {
          ...
          facts: [
            ...
            {
              label: '短い無音',
              description: '0.3秒未満では字幕を消さず、無音の中央で次のカードへ切り替えます。',
            },
            {
              label: '長い無音',
              description: '0.3秒以上では発話前後に約0.1秒ずつ字幕を残し、中央だけ非表示にします。',
            },
            {
              label: '解析できない場合',
      ...
      items: [
        {
          ...
          facts: [
            ...
            {
              label: '見た目',
              description: 'サイズ、字体、位置、縁、文字色、背景帯を「スタイル設定」で調整します。',
            },
          ],
        ...
        },
        {
          title: '個別設定（歯車マーク）',
          description:
            '歯車マークから、文字の縁幅・縁色・文字本体色、サイズ、位置、ぼかし、フェードをカードごとに設定できます。',
          bullets: [
        ...
        },
        {
          ...
          description: '歌詞や長い字幕を、複数行まとめて追加・編集できます。',
          bullets: [
