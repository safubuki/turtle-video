      ...
      items: [
        ...
        },
        {
          ...
          bullets: [
            ...
            'タイトルは主タイトルとサブタイトルを別々に複数行で書けます。見た目もそれぞれ設定できます。',
          ],
        },
        {
        ...
        },
        {
          title: 'カードの折りたたみ',
          description:
            'カードは閉じて並びを見ます。矢印か名前で開き、プレビュー位置のカードには枠が付きます。',
          bullets: [
            '閉じたままで上下移動、コピー、削除ができます。サムネイルの拡大は開閉しません。',
            '再生中は枠だけが移動します。終端で止まってもカードは開きません。スライダーを動かしたときに、そのカードが開きます。',
