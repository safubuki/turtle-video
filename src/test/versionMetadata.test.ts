...
describe('version metadata', () => {
  it('v5.1.7 の現在バージョンとキャプションサイズ 2 倍拡大の変更概要を持つ', () => {
    expect(versionData.version).toBe('5.1.7');
    expect(versionData.history.previousVersion).toBe('5.1.6');
    ...
    expect(versionData.history.highlights).toEqual(
      expect.arrayContaining([
        expect.objectContaining({ title: 'キャプションサイズを 2 倍へ拡大' }),
